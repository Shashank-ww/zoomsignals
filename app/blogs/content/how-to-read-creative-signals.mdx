...
ThisAdBreak exists to spot **repeatable creative patterns** early — not viral one-offs, not dashboards, and not hindsight analysis.
...
ThisAdBreak is **not** a performance tool.
