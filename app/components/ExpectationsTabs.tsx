...
<div className="border-t border-gray-200 dark:border-gray-800 my-8 md:my-12" />
  ...
  <h2 className="text-lg md:text-xl font-semibold">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        {/* LEFT — VISUAL PANEL */}
        <div className="relative rounded-2xl border bg-linear-to-br from-slate-50 to-white p-6 flex items-center justify-center min-h-60">
                ...
                className={`
                  ...
                  ${
                    active === i
                      ...
                      : "hover:border-amber-500/60 hover:bg-amber-50/40"
                  }
                `}
              >
                {/* ICON */}
